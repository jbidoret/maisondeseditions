                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:'Work Sans','Helvetica Neue';font-size:14px;line-height:18px;text-align:left;color:#000000;">
                        ...
                        <?php echo t("Votre commande à la Maison des éditions a été traitée.") ?>
                      </div>
                    </td>
                  </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:50px;word-break:break-word;">
                      <div style="font-family:'Work Sans','Helvetica Neue';font-size:23px;font-weight:bold;line-height:1;text-align:left;color:#000000;">
                        <?php echo t("Delivery mode") ?>
                      </div>
                    </td>
                  </tr>
                  <tr>
