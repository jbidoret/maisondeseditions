...
const prodConfig = {
  ...
  plugins: [
    ...
    new CopyPlugin([
      {
        from: user.paths.src + '/images',
        to: user.paths.kirby.assets + '/images',
      },
      {
        from: user.paths.src + '/fonts',
        to: user.paths.kirby.assets + '/fonts',
      },
      {
        from: user.paths.src + '/favicons',
        to: user.paths.kirby.assets + '/favicons',
      },
    ]),
